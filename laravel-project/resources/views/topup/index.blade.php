...
<div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
    ...
    <!-- Pending -->
    <div class="card-hover fade-up-2 rounded-2xl p-6 relative overflow-hidden bg-white border border-slate-200" style="box-shadow:0 2px 12px rgba(0,0,0,0.06);">
    ...
    <!-- New Top-up -->
    <div class="card-hover fade-up-3 rounded-2xl p-6 relative overflow-hidden bg-white border border-slate-200" style="box-shadow:0 2px 12px rgba(0,0,0,0.06);">
