...
@section('title', 'Reports - AdDashboard Pro')
...
<div class="grid grid-cols-1 md:grid-cols-4 gap-5 mb-5">
    ...
    <div class="card-hover fade-up rounded-2xl p-6 relative overflow-hidden bg-white border border-slate-200" style="box-shadow:0 2px 12px rgba(0,0,0,0.06); animation-delay:{{ $i*0.08 }}s;">
