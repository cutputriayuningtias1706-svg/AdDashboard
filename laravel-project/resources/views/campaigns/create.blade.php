    ...
    <form action="{{ route('campaigns.store') }}" method="POST" id="campaign-form" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="text" name="campaign_name" value="{{ old('campaign_name') }}" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-colors" placeholder="Contoh: Promo Akhir Tahun 2026" required>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="objective" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-colors appearance-none" required>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input type="date" name="start_date" value="{{ old('start_date', date('Y-m-d')) }}" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-colors" required>
                            </div>
                            <div>
                                ...
                                <input type="date" name="end_date" value="{{ old('end_date', date('Y-m-d', strtotime('+30 days'))) }}" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-colors" required>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                ...
                                <label class="relative cursor-pointer">
                                    ...
                                    <div class="p-4 border-2 border-slate-100 rounded-xl peer-checked:border-indigo-500 peer-checked:bg-indigo-50 transition-all hover:border-slate-300">
                                    ...
                                    <div class="absolute top-3 right-3 opacity-0 peer-checked:opacity-100 text-indigo-500">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                ...
                                <label class="relative cursor-pointer">
                                    ...
                                    <div class="p-3 text-center border-2 border-slate-100 rounded-xl peer-checked:border-purple-500 peer-checked:bg-purple-50 transition-all hover:border-slate-300">
                                        <div class="w-10 h-10 mx-auto rounded-full bg-white shadow-sm flex items-center justify-center mb-2">
                                            <i class="fa-solid fa-bullhorn text-purple-500"></i>
                                        </div>
                                        <p class="text-xs font-bold text-slate-700">{{ $pub }}</p>
                                    </div>
                                    <div class="absolute top-2 right-2 opacity-0 peer-checked:opacity-100 text-purple-500 text-xs">
                                        <i class="fa-solid fa-circle-check"></i>
                                    </div>
                                </label>
                                @endforeach
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
                    <h3 class="text-base font-semibold text-slate-800 mb-5 flex items-center gap-2">
                        <span class="w-6 h-6 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center text-xs">4</span>
                        Materi Iklan (Asset)
                    </h3>
                    ...
                    <div>
                        ...
                        <div class="relative flex justify-center items-center w-full h-40 border-2 border-dashed border-slate-300 bg-slate-50 rounded-xl hover:bg-slate-100 hover:border-indigo-400 transition-colors cursor-pointer group" id="drop-zone">
                        ...
                        <!-- File preview -->
                        <div id="file-preview" class="hidden mt-3 p-3 bg-indigo-50 border border-indigo-100 rounded-lg flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <i class="fa-solid fa-file-image text-indigo-500 text-xl" id="file-icon"></i>
                                <div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 sticky top-6">
                    ...
                    <div class="space-y-4 mb-6">
                        ...
                        <div class="pt-4 border-t border-slate-100">
                            <div class="flex justify-between items-end">
                                <span class="text-sm font-semibold text-slate-600">Total Disbursement</span>
                                <span class="text-xl font-bold text-indigo-600" id="summary-amount">Rp 0</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="submit" class="w-full py-3.5 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-xl font-semibold shadow-md shadow-indigo-200 transition-all transform hover:-translate-y-0.5 flex items-center justify-center gap-2">
...
<script>
    ...
    function showFile(file) {
        ...
        if (file.type.startsWith('video/')) {
            fileIcon.className = 'fa-solid fa-file-video text-indigo-500 text-xl';
        } else {
            fileIcon.className = 'fa-solid fa-file-image text-indigo-500 text-xl';
        }
